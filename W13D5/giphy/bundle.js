...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    debugger;
    var result = _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](searchTerm);
    debugger;
    result.then(function (giphys) {
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  ...
  var result = $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=kFPEiJd52pDLFdrxrECpB8IMLR8M8xlz&limit=5")
  });
  debugger;
  return result;
};
